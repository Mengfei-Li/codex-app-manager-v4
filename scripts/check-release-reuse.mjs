...
export function requiredReleaseAssetNames(releaseTag) {
  ...
  return [
    ...
    "CodexAppManager_portal_macos_aarch64.zip",
    "CodexAppManager_portal_macos_x86_64.zip",
    "CodexAppManager_portal_windows_aarch64.zip",
    "CodexAppManager_portal_windows_x86_64.zip",
